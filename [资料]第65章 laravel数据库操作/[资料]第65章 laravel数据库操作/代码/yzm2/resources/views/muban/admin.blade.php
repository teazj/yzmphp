	...
	<div class="container">
		...
		<nav class="navbar navbar-default navbar-fixed-top navbar-blue" role="navigation">
			...
			<!-- 导航logo -->
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="#"><img style="display:inline" width="30px" src="/admins/img/1.png" alt="">   云知梦后台管理系统</a>
				</div>
		...
		<div class="row body">
			...
			<div class="col-md-2">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h2 class="panel-title" id="pic"><span class="glyphicon glyphicon-user"></span> 图片 管理</h2>
					</div>
					<ul class="list-group">
