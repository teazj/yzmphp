		...
		<nav class="navbar navbar-default navbar-fixed-top navbar-color" role="navigation">
			...
			<!-- 导航logo -->
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="#"><img style="display:inline" width="30px" src="../public/img/1.png" alt="">   联想后台管理系统</a>
				</div>
		...
		<div class="row body">
			...
			<div class="col-md-2">
				...
				<div class="panel panel-primary">
					...
					<ul class="list-group">
					    <li class="list-group-item"><a href="./user/index.html">管理员列表</a></li>
